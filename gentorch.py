...
file = unidecode.unidecode(open("sergen-data.txt", encoding="utf8").read())
...
#gennames = Generator()
#gennames=torch.load("deneme3.tbt")

#string1=gennames.generate("deneyim")
#print(string1)
st.text("Yapay zeka Türkçe")
st.title('Türkçe yapay zeka')
title = st.text_input('Girin', 'giriş')
Nlpgen=Generator()
nlpprocessed=Nlpgen.generate("genetik")
st.text(nlpprocessed)
